# Source: https://git.drupalcode.org/project/drupal/-/blob/HEAD/core/.env.example
...
DRUPAL_TEST_WEBDRIVER_PORT=$CI_SERVICE_CHROMEDRIVER_PORT
...
DRUPAL_NIGHTWATCH_OUTPUT=$DRUPAL_NIGHTWATCH_OUTPUT
...
#
DRUPAL_NIGHTWATCH_SEARCH_DIRECTORY=$DRUPAL_NIGHTWATCH_SEARCH_DIRECTORY

# Filter directories to look for tests. This uses minimatch syntax.
# Separate folders with a comma.
DRUPAL_NIGHTWATCH_IGNORE_DIRECTORIES=$DRUPAL_NIGHTWATCH_IGNORE_DIRECTORIES
